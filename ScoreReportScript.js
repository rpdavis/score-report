...
(function () {
    ...
    function extractDataFromTable() {
        ...
        return { name, school, dateOfBirth, age, sex, dateOfTesting, examiners };
    }
    ...
    if (extractedData) {
        const { name, school, dateOfBirth, age, sex, dateOfTesting, examiners } = extractedData;

        // Populate the extracted data into the HTML content
        var introBodyContent = `
            <p><strong>I. Reason for Referral:</strong></p>
            <p>${name} was referred for this academic assessment as part of a 3-year re-evaluation for special education services. (Please see the psycho-educational report for additional information).</p>

            <p><strong>II. Methods of Data Collection:</strong></p>
            <p>The following procedures were used to obtain a valid estimate of ${name}'s academic achievement:</p>
            <ol>
            ...
            <p>${name} is an 8th grade student at ${school} receiving Special Education services in RSP English and RSP math. ${name} is a model student. She is well-behaved and works hard in all of her classes.</p>

            <p><strong>IV. Academic Testing:</strong></p>
            <p>${name} was administered the Woodcock-Johnson Tests of Achievement, fourth edition (WJ-IV-ACH) by ${examiners}, Special Education Teacher. The WJ-IV-ACH is a standardized test of achievement that can be used to assess basic academic skills.</p>

            <p>${name} was tested in a separate classroom over 5 days in forty-minute increments. The testing room was quiet and ${name} was attentive to the tasks in front of her. She appeared at ease and comfortable through the assessment. She was able to persist with difficult tasks though at times she would be slow to skip a question she did not know.</p>

            <p>Yes__ No___ The instrument used during this assessment has been validated for the specific purpose for which it was used.</p>
            <p>Yes__ No___ Assessment results were obtained through a valid administration of the test.</p>
            <p>Yes__ No___ These assessment results may be considered an accurate reflection of ${name}'s present level of academic functioning. During her timed assessments of math and writing fluency she would write the words “I don’t know” each time she skipped a problem. However, the delay is caused was relatively minimal.</p>

            <p><strong>${name}'s scores were as follows:</strong></p>
        `;
